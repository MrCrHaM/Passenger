...
def plot_image(path):
    ...
    def animate(i):
        im = ax.imshow(np.rot90(data[:,:,i]), cmap = 'viridis')
        return [im]
    return matplotlib.animation.FuncAnimation(fig, animate, frames=range(0,data.shape[2]), interval=200, blit=False)

def main():
    ani = plot_image('./stage1_aps/0d10b14405f0443be67a75554da778a0.aps')
